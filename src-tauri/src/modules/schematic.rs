...
async fn encode_uploaded_file(
    ...
    let (file_ext_str, file_name_str) = {
        let ext = path.extension()
            ...
            .unwrap_or_else(|| "unknown".into());  // 提供默认值
    ...
    match file_ext_str.unwrap().as_str() {
        "nbt" => {
